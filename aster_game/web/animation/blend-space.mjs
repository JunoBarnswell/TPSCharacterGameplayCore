const samples = [
  ["idle", 0, 0],
  ["walk_forward", 2 / 6.5, 0],
  ["walk_forward_right", 2 / 6.5, 0.25],
  ["walk_right", 2 / 6.5, 0.5],
  ["walk_backward_right", 2 / 6.5, 0.75],
  ["walk_backward", 2 / 6.5, 1],
  ["walk_backward_left", 2 / 6.5, -0.75],
  ["walk_left", 2 / 6.5, -0.5],
  ["walk_forward_left", 2 / 6.5, -0.25],
  ["run_forward", 4.5 / 6.5, 0],
  ["run_forward_right", 4.5 / 6.5, 0.25],
  ["run_right", 4.5 / 6.5, 0.5],
  ["run_backward_right", 4.5 / 6.5, 0.75],
  ["run_backward", 4.5 / 6.5, 1],
  ["run_backward_left", 4.5 / 6.5, -0.75],
