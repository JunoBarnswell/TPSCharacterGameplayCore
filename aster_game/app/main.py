...
async def metrics_endpoint() -> dict[str, int | float]:
    ...
    if metrics is None or rooms is None:
        return {
            ...
            "server_tick_duration_ms_p95": 0.0,
            ...
            "snapshot_size_bytes_avg_last_tick": 0.0,
            "snapshot_enqueue_rate_1s": 0,
            "snapshot_bytes_enqueued_per_second": 0,
            "snapshot_messages_enqueued_total": 0,
            "snapshot_bytes_enqueued_total": 0,
            "command_queue_size": 0,
            "movement_solver_duration_ms_avg": 0.0,
            "movement_solver_duration_ms_last": 0.0,
            "movement_solver_duration_ms_p95": 0.0,
            "physics_duration_ms_avg": 0.0,
            "physics_duration_ms_last": 0.0,
            "physics_duration_ms_p95": 0.0,
            "snapshot_duration_ms_avg": 0.0,
            "snapshot_duration_ms_last": 0.0,
            "snapshot_duration_ms_p95": 0.0,
        }
